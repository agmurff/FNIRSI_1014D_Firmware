//-------------------------------------------------------------------------------------
// 1014D RETARGET (2026-07-18) of Atlan4's 1013D AL3 design. Vendor source:
//   Atlan4-FPGA/FPGA AL3/FPGA AL3S10/zaklad.v — byte-identical except the blocks
//   marked "1014D retarget" (o_1khz_calib deleted, 1014D-only pins parked).
// Pinout: zaklad_1014d.adc. Read fpga/README.md (flash gates!) before any flashing.
//-------------------------------------------------------------------------------------
...
(
  ...
  //1014D retarget: o_1khz_calib DELETED — the 1013D cal/ext-trigger pin does not
  //exist on the 1014D, and its old location P133 is o_ac_dc_2 there.

  //1014D retarget: 1014D-only pins, parked safe until their functions are ported
  input  wire i_clk2,            //MS5351M CLK0 (200 MHz), unused by this design
  inout  wire io_i2c_scl,        //"special IC" U5 bus — released, pullups idle it high
  inout  wire io_i2c_sda,
  output wire [7:0] o_dac_d,     //AWG R-2R DAC ladder — held at 0x00 = 0 V
...
//1014D retarget: the o_1khz_calib assign deleted with the port; the DDS above stays
//for a future DAC-based generator port. Parked 1014D-only pins held safe:
  assign o_dac_d    = 8'h00;
  assign io_i2c_scl = 1'bZ;
  assign io_i2c_sda = 1'bZ;
